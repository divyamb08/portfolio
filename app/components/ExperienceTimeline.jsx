...
<ol class="relative border-s border-gray-200 dark:border-gray-700">                  
    ...
    <li class="mb-10 ms-6">
        ...
        <time class="block mb-2 text-2lg  leading-none text-white dark:text-gray-500">Indian School of Business</time>
...
visualized using popular EDA techniques for effective decision making.</p>
    ...
    <li class="ms-6">
        ...
        <h3 class="flex items-center mb-1 text-2xl font-semibold text-ivory dark:text-white">Python Developer </h3>
        <time class="block mb-2 text-2lg  leading-none text-white dark:text-gray-500">Avalor Investments Pvt. Ltd.</time>
...
volatility, volume, etc.</p>
    ...
    <li class="ms-6">
        ...
        <time class="block mb-2 text-2lg  leading-none text-white dark:text-gray-500">Winwire Technologies Inc.</time>
...
percentage match for an individual profile with the job description. Visualized using matplotlib for efficient hiring.</p>
    ...
    <li class="ms-6">
        ...
        <h3 class="flex items-center mb-1 text-2xl font-semibold text-ivory dark:text-white">Summer Intern/Trainee</h3>
        <time class="block mb-2 text-2lg  leading-none text-white dark:text-gray-500">Marico Limited</time>
