...
const HeroSection = () => {
  return (
    ...
    <section className="min-h-screen flex justify-center items-center lg:py-16">
      <div className="grid grid-cols-1 sm:grid-cols-12 h-full items-center">
        ...
        >
          ...
          <div>
            ...
            >
              <span className="block bg-[#121212] hover:bg-slate-800 rounded-full px-5 py-2 sm:w-fit">
                Download CV
              </span>
            </Link>
          </div>
